...
def test_classify_ws_failure_reason_tokens() -> None:
    ...
    assert classify_ws_failure_reason("transport error") == "eio_close"
    assert classify_ws_failure_reason("transport close") == "eio_close"
    assert classify_ws_failure_reason("server disconnect") == "disconnect"
    assert classify_ws_failure_reason("client disconnect") == "disconnect"
