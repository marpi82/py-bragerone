...
5. **Coverage**: pre-push gate is `--cov-fail-under=80`; CI uploads to Codecov (patch target 100%, project informational). New modules should ship with meaningful tests, not just line coverage.
